          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <div class="form-group">
                  ...
                  <?php echo form_error('nama', '<small class="text-danger p-2">','</small>'); ?>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="email" name="email" placeholder="Email Address">
                  <?php echo form_error('email', '<small class="text-danger p-2">','</small>'); ?>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="password" class="form-control form-control-user" id="password1" name="password1" placeholder="Password">
                    <?php echo form_error('password1', '<small class="text-danger p-2">','</small>'); ?>
                  </div>
                  <div class="col-sm-6">
              ...
              <div class="text-center">
                <a class="small" href="<?php echo base_url('autentifikasi'); ?>">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
